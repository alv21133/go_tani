        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase" >
              <strong>MARI KENALI POTENSI LAHAN PERTANIAN ANDA DISINI</strong>
            </h1>
            <hr>
          </div>
          <div class="col-lg-8 mx-auto">
            <p class="text-faded mb-4">Temukan tanaman yang tepat untuk di tanam di lahan yang anda miliki dengan menggunakan teknilogi farward chaining dari kami</p>
