...
if (isset($_POST["tambah"])) {
   ...
   $id_tanaman = uniqid("TA");
   $query = "INSERT INTO tanaman VALUES (
                           '$id_tanaman',
                           '$nama',
                           '$waktu_panen',
                           '$harga',
                                ...
                                <input type="text" name="id_tanaman" value="<?= $id_tanaman?>" hidden>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input disabled class="form-control-static form-control" name="id_tanaman">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input required type="number" id="panen-input" name="waktu_panen" value="" placeholder="Enter Day to Common Harvest" class="form-control" required><small class="help-block form-text">Please enter harvest time </small></div>
                                    </div>
                                    <div class="row form-group">
